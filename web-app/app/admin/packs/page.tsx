    ...
    return (
        <main className="flex-1 p-8 md:p-12 space-y-12 overflow-y-auto h-screen">
            <header className="space-y-2 border-b border-white/5 pb-8">
                <h2 className="text-2xl md:text-3xl font-black uppercase italic tracking-tight leading-none whitespace-nowrap">Gestión de <span className="neon-text-yellow">Packs VIP</span></h2>
